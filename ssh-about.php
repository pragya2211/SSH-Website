...
<p align="justify">Catering to undergraduate studies, the department delivers core courses and elective modules
for an innovative new degree programme, the B.Tech in computer science and Social Sciences (CSSS)
...
PhD in Economics and Sociology. The department houses a wide range of laboratories like
Econometrics, Game theory and cognitive science, enriched in facilities providing a platform for
...
systems. It is concievable that an increasing role that IT will play in addressing
society&#39;s problems, as well as answering the human questions posed by social scientists, will lead to an
increase in demand for IT experts who are well versed in the social sciences and also of social
scientists who understand computing and IT and apply them innovatively to solve problems in their
own domain. The SSH department at IIIT Delhi would seek to bridge the disciplinary boundaries that
exist between various IT and social science streams and develop a cross -disciplinary research and
teaching agenda that is forward looking and cutting edge in technology education. </p>

<h2>Vision</h2>
<br>
<p align="justify">Modern university systems all over the world evolved by separating out the study of science and technology from that of the liberal arts - philosophy, literature and history. Even the social sciences - economics, sociology, anthropology and psychology - which emerged later under the strong influence of the methods and goals of science, could not shake off this divide. But today, the influence of science and technology over actual human lives and societies has increased so dramatically, that this division in knowledge can no longer be supported. The development of Information Technology in particular, has raised an urgent need over the last few decades, to be studied and researched in its social context, given its huge potential for public good and the speed and intensity with which it has overtaken our everyday lives.</p>
...
research program and offers a range of courses in Economics, Sociology and Cognitive
Sciences as well as from the broader grouping of Liberal Arts, Communications and Humanities to the
students of the Institute. The Department is home to the B.Tech. in IT and Social Sciences programme
and provides the core teaching and research support for this innovative educational offering.</p>
